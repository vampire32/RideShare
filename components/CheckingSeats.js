		...
		<View style={styles.container}>
			...
			></Button> */}
				...
				>
					...
					<View style={styles.group2}>
						<View style={styles.rectRow}>
							<View style={styles.rect}>
								<Text style={styles.loremIpsum}>Booked no1</Text>
							</View>
						...
						<View style={styles.rect2Row}>
							<View style={styles.rect2}>
								<Text style={styles.loremIpsum2}>Booked no2</Text>
							</View>
					...
					<TouchableHighlight
						onPress={() => {
							navigation.replace("CustomerRoute");
						}}
					>
